package com.study.security.user.entity;
...
public class User {
    ...
    public User(int userNo, String userId, String userPass, String userName, String userEmail, OhgiraffersRole role, String state) {
        this.userNo = userNo;
        this.userId = userId;
